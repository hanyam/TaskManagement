...
public class TaskEfQueryRepository : IQueryRepository<DomainTask>
{
    ...
    public TaskEfQueryRepository(ApplicationDbContext context)
    {
        _context = context;
    }
    ...
    public async Task<IEnumerable<DomainTask>> FindAsync(string sql, object? param = null, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<DomainTask?> FirstOrDefaultAsync(string sql, object? param = null, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<IEnumerable<DomainTask>> GetTasksByStatusAsync(DomainTaskStatus status, CancellationToken cancellationToken = default)
    {
        return await _context.Tasks
            .Include(t => t.AssignedUser)
    ...
    public async Task<IEnumerable<DomainTask>> GetTasksByCreatedByAsync(string createdBy, CancellationToken cancellationToken = default)
    {
        return await _context.Tasks
            .Include(t => t.AssignedUser)
