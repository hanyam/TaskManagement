...
public class UserDapperRepositoryWrapper : UserDapperRepository
{
    ...
    public override async Task<IEnumerable<User>> FindAsync(string sql, object? param = null,
        CancellationToken cancellationToken = default)
    {
        return await _efRepository.FindAsync(sql, param, cancellationToken);
    }

    public override async Task<User?> FirstOrDefaultAsync(string sql, object? param = null,
        CancellationToken cancellationToken = default)
    {
        return await _efRepository.FirstOrDefaultAsync(sql, param, cancellationToken);
    }

    public override async Task<int> CountAsync(string sql, object? param = null,
        CancellationToken cancellationToken = default)
    {
    ...
    public override async Task<IEnumerable<User>> SearchManagedUsersAsync(Guid managerId, string searchQuery,
        CancellationToken cancellationToken = default)
    {
