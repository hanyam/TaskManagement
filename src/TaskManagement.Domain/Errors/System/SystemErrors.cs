...
public static class SystemErrors
{
    ...
    public static Error RequiredFieldMissing(string fieldName) => Error.Validation($"Required field '{fieldName}' is missing", fieldName);
    public static Error InvalidFormat(string fieldName) => Error.Validation($"Invalid format for field '{fieldName}'", fieldName);
    public static Error ValueTooLong(string fieldName, int maxLength) => Error.Validation($"Field '{fieldName}' cannot exceed {maxLength} characters", fieldName);
    public static Error ValueTooShort(string fieldName, int minLength) => Error.Validation($"Field '{fieldName}' must be at least {minLength} characters", fieldName);
    ...
    public static Error ConfigurationMissing(string configKey) => Error.Internal($"Configuration '{configKey}' is missing");
    public static Error InvalidConfiguration(string configKey) => Error.Internal($"Invalid configuration for '{configKey}'");
    public static Error EnvironmentVariableMissing(string variableName) => Error.Internal($"Environment variable '{variableName}' is missing");
