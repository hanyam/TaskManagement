...
import type { ApiClient, ApiEnvelope, ApiRequestConfig, ApiSuccessResponse } from "@/core/api/types";
...
export const apiClient: ApiClient = {
  async request<TResponse, TBody = unknown, TQuery = Record<string, unknown>>(
    ...
    const authToken = config.auth === false ? undefined : await resolveAuthToken();
